...
// Auth information
global.pairNumber = "94751322602";                         // Add your paining number with country code example "94751322602"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["94751322602", "94751322602"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["94751322602", "94751322602"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["94751322602"];
global.OwnerName = process.env.OWNER_NAME || "mafia_boy";
